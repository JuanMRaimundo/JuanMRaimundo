...
Transportes Guzzo (Full Stack): Desarrollé una plataforma integral para digitalizar la logística de camiones y sus cargas, eliminando el uso de Excel y reduciendo tiempos administrativos mediante una API customizada.
